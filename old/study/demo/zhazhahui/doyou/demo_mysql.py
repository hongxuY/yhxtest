...
def add_student():
    ...
    ret_dic = {"ret_code": "200", "ret_msg": "添加学生成功！",
...
def delete_student():
    ...
    ret_dic = {
        "return_code": "200",
        "return_msg": "Update studeng success!",
        "student": {"s_id":stu.s_id,"s_no":stu.s_no,"s_name":stu.s_name,"s_age":stu.s_age}}
    return jsonify(ret_dic)
...
def update_student_info():
    ...
    ret_dic={
        "return_code":"200",
        "return_msg":"Update studeng success!",
        "student":{'s_no': stu_no, 's_name': stu_name, 's_age': stu_age}
    }
    return jsonify(ret_dic)
...
def search_student():
    ...
    ret_dic = {
        "return_code": '200',
        "return_msg": "Search student success",
        "count": len(student_list),
